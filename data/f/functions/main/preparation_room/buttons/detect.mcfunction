...
execute if score $f.preparationRoom.buttons.push.confirmStart buttonDetect matches 1 run setblock 9 30 4 polished_blackstone_button[facing=south] destroy
execute if score $f.preparationRoom.buttons.push.confirmStart buttonDetect matches 1 run scoreboard players reset $f.preparationRoom.buttons.push.confirmStart buttonDetect
